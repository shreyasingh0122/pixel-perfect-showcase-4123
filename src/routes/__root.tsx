  ...
  head: () => ({
    meta: [
      ...
      { title: "FutureLens — Explore Your Possible Futures" },
      {
        name: "description",
        content:
          "FutureLens turns your goals, skills and constraints into three model-based future scenarios — so you can compare paths before you commit.",
      },
      { name: "author", content: "FutureLens" },
